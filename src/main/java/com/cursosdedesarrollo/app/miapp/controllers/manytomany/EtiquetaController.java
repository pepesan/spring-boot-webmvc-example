package com.cursosdedesarrollo.app.miapp.controllers.manytomany;
...
import com.cursosdedesarrollo.app.miapp.repositories.manytomany.EtiquetaRepository;
import com.cursosdedesarrollo.app.miapp.repositories.manytomany.NoticiaRepository;
...
public class EtiquetaController {
    ...
    public String insert(Model modelo) {
        ...
        if ( actualSize.equals(0)){
            ...
            System.out.println("/mvc/insert: etiqueta="+etiqueta);
        }
